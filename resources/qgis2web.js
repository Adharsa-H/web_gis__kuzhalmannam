...
map.getView().fit([8519871.992251, 1194218.227147, 8533152.513938, 1203558.174946], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">kuzhalmannam_webgis</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (172 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map contains the basic details of kuzhalmannam panchayat. Its prepared by Adharsa H, 1st M.Sc geography student of sree sankaracharya university of sanskrit, kalady.  ';
            }
